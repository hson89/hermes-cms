...
<span class="material-symbols-outlined size-32">favorite</span>
```
...
```astro
<span class="material-symbols-outlined">icon_name_here</span>
```
...
```astro
<!-- Using inline styles -->
<span class="material-symbols-outlined" style="color: #094cb2;">favorite</span>

<!-- Using CSS variables -->
<span class="material-symbols-outlined" style="color: var(--color-tertiary);">star</span>
```
