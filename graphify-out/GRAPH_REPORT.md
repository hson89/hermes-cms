...
## Corpus Check
- 614 files · ~427,667 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9209 nodes · 10518 edges · 871 communities (704 shown, 167 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 312 edges (avg confidence: 0.64)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `175e753e`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- [[_COMMUNITY_AI Batching & Prompt Pipeline|AI Batching & Prompt Pipeline]]
- [[_COMMUNITY_AI Audit Logs & Rate Limiting|AI Audit Logs & Rate Limiting]]
- [[_COMMUNITY_Admin Actions & Content Init|Admin Actions & Content Init]]
- [[_COMMUNITY_AI Copilot Drafting Service|AI Copilot Drafting Service]]
- [[_COMMUNITY_Design System & UI Components|Design System & UI Components]]
- [[_COMMUNITY_AI Content Creation Tests|AI Content Creation Tests]]
- [[_COMMUNITY_Admin Custom Views & Import Map|Admin Custom Views & Import Map]]
- [[_COMMUNITY_Text Animation Catalog|Text Animation Catalog]]
- [[_COMMUNITY_AI Agent Session Management|AI Agent Session Management]]
- [[_COMMUNITY_Animation Build Configs|Animation Build Configs]]
- [[_COMMUNITY_AI Self-Correction Loop|AI Self-Correction Loop]]
- [[_COMMUNITY_Deployment & Payload Types|Deployment & Payload Types]]
- [[_COMMUNITY_Admin View & Block Library|Admin View & Block Library]]
- [[_COMMUNITY_Animation Library Adapters|Animation Library Adapters]]
- [[_COMMUNITY_MCP Tool Adapters (Python)|MCP Tool Adapters (Python)]]
- [[_COMMUNITY_AI Authoring Service Core|AI Authoring Service Core]]
- [[_COMMUNITY_Animation Stage Presets|Animation Stage Presets]]
- [[_COMMUNITY_Depth Parallax Words Animation|Depth Parallax Words Animation]]
- [[_COMMUNITY_Soft Blur In Animation|Soft Blur In Animation]]
- [[_COMMUNITY_Tenant Access Control|Tenant Access Control]]
- [[_COMMUNITY_Schema Validator Domain Tests|Schema Validator Domain Tests]]
- [[_COMMUNITY_Stagger From Center Animation|Stagger From Center Animation]]
- [[_COMMUNITY_Stagger From Edges Animation|Stagger From Edges Animation]]
- [[_COMMUNITY_Bottom-Up Letters Animation|Bottom-Up Letters Animation]]
- [[_COMMUNITY_Per-Word Crossfade Animation|Per-Word Crossfade Animation]]
- [[_COMMUNITY_Top-Down Letters Animation|Top-Down Letters Animation]]
- [[_COMMUNITY_Shared Axis Horizontal Animation|Shared Axis Horizontal Animation]]
- [[_COMMUNITY_Per-Character Rise Animation|Per-Character Rise Animation]]
- [[_COMMUNITY_Depth Parallax Words (Alt)|Depth Parallax Words (Alt)]]
- [[_COMMUNITY_Fade Through Animation|Fade Through Animation]]
...
- [[_COMMUNITY_Module Group 759|Module Group 759]]
...
- [[_COMMUNITY_Module Group 763|Module Group 763]]
...
1. `AIService` - 55 edges
2. `Icon()` - 47 edges
3. `AIAgentSession` - 31 edges
4. `DraftingService` - 26 edges
5. `RefineService` - 24 edges
6. `CMSClient` - 22 edges
7. `Badge()` - 22 edges
8. `BRANDING` - 21 edges
9. `skills` - 19 edges
10. `Payload Field Types Reference` - 19 edges

## Surprising Connections (you probably didn't know these)
- `Graphify Git Hooks and Claude Integration` --semantically_similar_to--> `Speckit Git Auto-Commit Command`  [INFERRED] [semantically similar]
  .claude/skills/graphify/references/hooks.md → .specify/extensions/git/commands/speckit.git.commit.md
- `Content Management Engine (CMS Monolith)` --semantically_similar_to--> `Content Management Engine`  [INFERRED] [semantically similar]
  docs/architecture.md → apps/content-management-engine/README.md
- `AI Suggestion Self-Correction Loop` --rationale_for--> `AIService`  [EXTRACTED]
  specs/003-define-content-types/research.md → apps/content-authoring-service/src/application/ai_service.py
- `AIService` --shares_data_with--> `Schema Generation API Contract`  [EXTRACTED]
  apps/content-authoring-service/src/application/ai_service.py → specs/003-define-content-types/contracts/schema-generation.md
- `Content Authoring Service (AI Microservice)` --semantically_similar_to--> `Content Authoring Service`  [INFERRED] [semantically similar]
  docs/architecture.md → apps/content-authoring-service/README.md

## Import Cycles
- 1-file cycle: `apps/content-authoring-service/src/main.py -> apps/content-authoring-service/src/main.py`
- 1-file cycle: `apps/content-authoring-service/src/application/copilot_service.py -> apps/content-authoring-service/src/application/copilot_service.py`
- 1-file cycle: `apps/content-authoring-service/src/domain/repositories/session_repository.py -> apps/content-authoring-service/src/domain/repositories/session_repository.py`
- 1-file cycle: `apps/content-authoring-service/src/infrastructure/repositories/session_repository.py -> apps/content-authoring-service/src/infrastructure/repositories/session_repository.py`

## Hyperedges (group relationships)
- **Deep Agents Backends** — deep_agents_memory_skill_state_backend, deep_agents_memory_skill_store_backend, deep_agents_memory_skill_composite_backend, deep_agents_memory_skill_filesystem_backend [EXTRACTED 1.00]
- **Deep Agents Orchestration Middlewares** — deep_agents_orchestration_skill_todolist_middleware, deep_agents_orchestration_skill_subagent_middleware, deep_agents_orchestration_skill_hitl_middleware [EXTRACTED 1.00]
- **LangGraph Core Architecture Components** — langgraph_fundamentals_skill_stategraph, langgraph_fundamentals_skill_nodes, langgraph_fundamentals_skill_edges, langgraph_fundamentals_skill_command, langgraph_fundamentals_skill_send [EXTRACTED 1.00]
- **Payload CMS Database Adapters** — reference_adapters_mongodb_adapter, reference_adapters_postgres_adapter, reference_adapters_sqlite_adapter [EXTRACTED 1.00]
- **Langfuse Observability & Attribute Propagation** — references_instrumentation_trace_metadata, references_instrumentation_trace_names, references_instrumentation_span_hierarchy, references_sdk_upgrade_propagate_attributes [INFERRED 0.85]
- **Spec Kit Git Integration Extensions** — speckit_git_commit_skill_auto_commit, speckit_git_feature_skill_create_branch, speckit_git_initialize_skill_init, speckit_git_remote_skill_detect, speckit_git_validate_skill_validate [EXTRACTED 1.00]
- **Spec Kit Core Feature Specification and Implementation Lifecycle** — speckit_specify_skill_workflow, speckit_clarify_skill_workflow, speckit_plan_skill_workflow, speckit_tasks_skill_workflow, speckit_analyze_skill_workflow, speckit_implement_skill_workflow [EXTRACTED 1.00]
- **Payload CMS Core Reference Guides** — reference_field_type_guards_file, reference_fields_file, reference_hooks_file, reference_queries_file, reference_plugin_development_file [EXTRACTED 1.00]
- **Git Workflow Commands** — commands_speckit_git_commit_main, commands_speckit_git_feature_main, commands_speckit_git_initialize_main, commands_speckit_git_remote_main, commands_speckit_git_validate_main [EXTRACTED 1.00]
- **CMS Constitution Principles** — memory_constitution_principle_1, memory_constitution_principle_2, memory_constitution_principle_3, memory_constitution_principle_4, memory_constitution_principle_5, memory_constitution_principle_6, memory_constitution_principle_7 [EXTRACTED 1.00]
- **Graphify Reference Guides** — references_add_watch_add_url, references_add_watch_watch, references_exports_ref, references_extraction_spec_ref, references_github_and_merge_ref, references_hooks_ref, references_query_ref, references_transcribe_ref, references_update_ref [EXTRACTED 1.00]
- **Hermes Hybrid Architecture** — docs_architecture_content_management_engine, docs_architecture_content_authoring_service, 001_ai_headless_cms_research_language_version_decision [EXTRACTED 1.00]
- **AI Headless CMS Architectural Decisions** — 001_ai_headless_cms_research_language_version_decision, 001_ai_headless_cms_research_multi_tenancy_decision, 001_ai_headless_cms_research_comms_decision [EXTRACTED 1.00]
- **Managed Frontend Site Starters** — astro_portfolio_readme_starter, nextjs_blog_readme_starter, content_management_engine_readme_hosted_sites_management [INFERRED 0.95]
- **Schema Generation and Validation Flow** — contracts_schema_generation_schema_generation, contenttypes_endpoints_post_generate_schema, application_ai_service_aiservice, domain_schema_validator_schemavalidator [INFERRED 0.95]
- **Tenant Hostname Resolution Flow** — contracts_tenant_resolution_tenant_resolution, services_tenant_service_resolvetenantbyhostname, 002_tenant_management_research_tenant_resolution [INFERRED 0.95]
- **AI Content Drafting Collections** — 004_ai_content_drafting_spec_drafting_sessions_collection, 004_ai_content_drafting_spec_style_modifiers_collection, 004_ai_content_drafting_spec_ai_audit_logs_collection, 004_ai_content_drafting_spec_ai_rate_limits_collection [EXTRACTED 1.00]
- **App Marketplace Integration Security** — 005_app_marketplace_plan_jwt_tokens_collection, 005_app_marketplace_plan_jwt_generation_endpoint, 005_app_marketplace_spec_ai_tool_circuit_breaker [INFERRED 0.95]
- **Template Builder Core Entities** — 006_template_builder_data_model_page_template, 006_template_builder_data_model_building_block, 006_template_builder_data_model_template_deployment [EXTRACTED 1.00]
- **A2A & MCP Integration Flow** — 007_a2a_mcp_integration_spec_feature, contracts_a2ui_dsl_spec, contracts_sse_api_contract [EXTRACTED 1.00]
...
## Communities (871 total, 167 thin omitted)

### Community 0 - "AI Batching & Prompt Pipeline"
Cohesion: 0.07
Nodes (58): buildBatchPrompt(), clampBatchSize(), createBatches(), formatValue(), renderItemsBlock(), renderTaskBlock(), resolveBatchGroups(), unpackBatchResults() (+50 more)

### Community 1 - "AI Audit Logs & Rate Limiting"
Cohesion: 0.04
Nodes (11): AIAuditLogs, AIRateLimits, AuditLogs, generateMarketplaceTokenEndpoint, MarketplaceApps, configPromise, dirname, filename (+3 more)

### Community 2 - "Admin Actions & Content Init"
Cohesion: 0.15
Nodes (28): setupInitialAdmin(), FieldDefinition, Button(), ButtonProps, Heading(), HeadingProps, Input(), InputProps (+20 more)

### Community 3 - "AI Copilot Drafting Service"
Cohesion: 0.05
Nodes (69): AI Suggestion Self-Correction Loop, AIService, Any, AIService, Application-layer service for AI-powered content operations.      Responsibiliti, Lazy initialization of the Langfuse client., CopilotService, Application-layer service for the AI Copilot (inline content editing).      The (+61 more)

### Community 4 - "Design System & UI Components"
Cohesion: 0.15
Nodes (36): Badge(), BadgeProps, BRANDING, FilterChips(), FilterChipsProps, FilterOption, RegistryHeader(), RegistryHeaderProps (+28 more)

### Community 5 - "AI Content Creation Tests"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (32): FieldsDataEditor(), GenerateTokenButton(), GenerateTokenButtonProps, importMap, GeneratorView(), Header(), Args, metadata (+24 more)

### Community 7 - "Text Animation Catalog"
Cohesion: 0.05
Nodes (45): word_opacity_duration_ms, word_opacity_from, word_opacity_to, duration_ms, easing, from, stagger_ms, to (+37 more)

### Community 8 - "AI Agent Session Management"
Cohesion: 0.05
Nodes (42): ABC, AIAgentSession, Aggregate root for the AI Agent context.      Tracks a single user's conversatio, Mark the session as completed., Mark the session as failed., Convert the conversation history to LangChain message format         (list of di, AIAgentSessionModel, Refines an existing draft based on user feedback. (+34 more)

### Community 9 - "Animation Build Configs"
Cohesion: 0.05
Nodes (42): build, word_opacity_duration_ms, word_opacity_from, word_opacity_to, custom_renderer, description, display_name, enter (+34 more)

### Community 10 - "AI Self-Correction Loop"
Cohesion: 0.27
Nodes (9): Any, RunnableConfig, call_schema_llm(), LangGraph nodes for the Schema Generation state machine., Validates the generated schema and captures validation errors for self-correctio, Helper to convert Pydantic FieldDefinition objects back to standard dicts., Invokes the LLM configured for structured schema output., _serialize_field() (+1 more)

### Community 11 - "Deployment & Payload Types"
Cohesion: 0.05
Nodes (37): AiAuditLog, AiAuditLogsSelect, AiPromptHistory, AiPromptHistorySelect, AiRateLimit, AiRateLimitsSelect, ApiKeyAuthOperations, ApiKeysSelect (+29 more)

### Community 12 - "Admin View & Block Library"
Cohesion: 0.05
Nodes (36): AdminView(), AdminViewProps, Icon(), IconProps, BlockLibrary(), BuilderCanvas(), BuilderCanvasProps, BuilderWorkspace() (+28 more)

### Community 13 - "Animation Library Adapters"
Cohesion: 0.06
Nodes (39): gsap, cancellation, completion, easing, import_statement, install, keyframe_shape, renderers (+31 more)

### Community 14 - "MCP Tool Adapters (Python)"
Cohesion: 0.08
Nodes (37): Any, BaseModel, CallToolResult, mock_llm(), A2UIBase, A2UICard, A2UIChart, A2UIChartDataset (+29 more)

### Community 15 - "AI Authoring Service Core"
Cohesion: 0.09
Nodes (27): AIService, AIService, ContentSchemaOutput, FieldDefinition, Domain-level Pydantic structures for schema model output., Structured model for individual fields inside a content type schema., The final structured schema generated by the AI model., ai_service() (+19 more)

### Community 16 - "Animation Stage Presets"
Cohesion: 0.07
Nodes (36): perspective_note, perspective_px, requirement, default-text-host, container, purpose, title, unit (+28 more)

### Community 17 - "Depth Parallax Words Animation"
Cohesion: 0.07
Nodes (35): duration_ms, easing, from, stagger_ms, to, duration_ms, easing, from (+27 more)

### Community 18 - "Soft Blur In Animation"
Cohesion: 0.07
Nodes (35): description, display_name, enter, duration_ms, easing, from, stagger_ms, to (+27 more)

### Community 19 - "Tenant Access Control"
Cohesion: 0.40
Nodes (5): StateGraph for autonomous and self-correcting page template generation., State tracking across the template builder graph workflow., Decides whether to retry design analysis or exit., should_continue_builder(), TemplateBuilderState

### Community 20 - "Schema Validator Domain Tests"
Cohesion: 0.07
Nodes (37): Any, TestClient, Domain Content Schema Validator. Satisfies T011.  Enforces structural validity a, Validate that the generated content schema conforms strictly to the system's str, Recursively validates a list of field definitions., validate_content_schema(), _validate_field_definitions(), client() (+29 more)

### Community 21 - "Stagger From Center Animation"
Cohesion: 0.07
Nodes (34): duration_ms, easing, from, stagger_ms, to, duration_ms, easing, from (+26 more)

### Community 22 - "Stagger From Edges Animation"
Cohesion: 0.07
Nodes (34): duration_ms, easing, from, stagger_ms, to, duration_ms, easing, from (+26 more)

### Community 23 - "Bottom-Up Letters Animation"
Cohesion: 0.06
Nodes (34): description, display_name, enter, duration_ms, easing, from, stagger_ms, to (+26 more)

### Community 24 - "Per-Word Crossfade Animation"
Cohesion: 0.06
Nodes (34): description, display_name, enter, duration_ms, easing, from, stagger_ms, to (+26 more)

### Community 25 - "Top-Down Letters Animation"
Cohesion: 0.06
Nodes (34): description, display_name, enter, duration_ms, easing, from, stagger_ms, to (+26 more)

### Community 26 - "Shared Axis Horizontal Animation"
Cohesion: 0.07
Nodes (33): duration_ms, easing, from, stagger_ms, to, duration_ms, easing, from (+25 more)

### Community 27 - "Per-Character Rise Animation"
Cohesion: 0.07
Nodes (33): description, display_name, enter, duration_ms, easing, from, stagger_ms, to (+25 more)

### Community 28 - "Depth Parallax Words (Alt)"
Cohesion: 0.08
Nodes (31): description, display_name, enter, duration_ms, easing, from, stagger_ms, to (+23 more)

### Community 29 - "Fade Through Animation"
Cohesion: 0.08
Nodes (31): description, display_name, enter, duration_ms, easing, from, stagger_ms, to (+23 more)
...
Cohesion: 0.08
Nodes (31): CLAUDE Config, Speckit Git Auto-Commit Command, Speckit Git Create Feature Branch Command, Speckit Git Initialize Repository Command, Speckit Git Detect Remote Command, Speckit Git Validate Branch Command, Git Branching Workflow Config Template, Git Branching Workflow Extension Manifest (+23 more)

### Community 32 - "Module Group 32"
Cohesion: 0.06
Nodes (31): dependencies, @assistant-ui/react, @dnd-kit/core, @dnd-kit/sortable, @dnd-kit/utilities, graphql, jsonwebtoken, langfuse (+23 more)

### Community 33 - "Module Group 33"
Cohesion: 0.08
Nodes (30): description, display_name, enter, duration_ms, easing, from, stagger_ms, to (+22 more)
...
Cohesion: 0.08
Nodes (29): description, display_name, enter, duration_ms, easing, from, stagger_ms, to (+21 more)
...
Cohesion: 0.08
Nodes (27): description, display_name, enter, duration_ms, easing, from, stagger_ms, to (+19 more)
...
Cohesion: 0.10
Nodes (14): ChatPanelProps, DRAFT_PRESETS, markdownComponents, MessageContentFormatter(), ParsedBlock, PresetAction, SCHEMA_PRESETS, AssistantUiMessage (+6 more)

### Community 48 - "Module Group 48"
Cohesion: 0.10
Nodes (22): ConversationMessage, AIAgentSession domain model and aggregate root.  T014 - Create AIAgentSession mo, Lifecycle states for an AI Agent conversation session., A single message in the conversation history., Append a message to the conversation history and touch updated_at., SessionStatus, Creates a new schema generation session, invokes the LangGraph schema_graph,, Continues an existing schema co-creation session, returning a real-time SSE even (+14 more)
...
Cohesion: 0.06
Nodes (31): A2A, MCP & A2UI Integration Developer & Operator Manual, A2A, MCP & A2UI Integration Implementation Plan, A2A, MCP & A2UI Integration Research & Rationale, Internal API Key Validation, A2A, MCP & A2UI Integration Spec, SSE (Server-Sent Events) Transport, Stdio Transport, Template Builder Data Model (+23 more)
...
Cohesion: 0.08
Nodes (24): perspective_note, perspective_px, requirement, coordinate_origin, position, requirement, absolute_centered, backface_visibility (+16 more)
...
Cohesion: 0.08
Nodes (32): Any, Request, Any, RunnableConfig, Any, AsyncClient, AsyncClient, CMSClient (+24 more)
...
Cohesion: 0.10
Nodes (21): Atomic Promotion Transaction Safety, Auto-Save Strategy, DraftingSession Locking and Lifecycle, Version Snapshot Strategy, DraftingSessions Collection, BuildingBlock Collection, PageTemplate Collection, TemplateDeployment Collection (+13 more)

### Community 70 - "Module Group 70"
Cohesion: 0.12
Nodes (12): Any, MCPSessionContext, MCPSessionRegistry, Update last active timestamp to keep the session alive., In-memory registry to store and manage active MCP client sessions., Create a new session context and register it., Retrieve a session by ID and update its active timestamp., Revoke/remove a session from the registry. (+4 more)

### Community 71 - "Module Group 71"
Cohesion: 0.15
Nodes (19): ChatPromptTemplate, get_copilot_prompt(), get_drafting_prompt(), get_healing_prompt(), get_refinement_prompt(), get_schema_generation_prompt(), LLM prompt templates for content drafting.  T013 - Formulate LLM prompts and str, Get the ChatPromptTemplate for content drafting.     Attempts to fetch templates (+11 more)

### Community 72 - "Module Group 72"
Cohesion: 0.10
Nodes (21): devDependencies, autoprefixer, eslint, jest, jest-environment-jsdom, playwright, @playwright/test, postcss (+13 more)
...
Cohesion: 0.11
Nodes (21): duration_ms, easing, from, stagger_ms, to, duration_ms, easing, from (+13 more)
...
Cohesion: 0.19
Nodes (11): exportSchemaEndpoint, exportSchemaTSEndpoint, generateSchemaEndpoint, getSessionStatusEndpoint, listCollectionsEndpoint, postSessionMessageEndpoint, afterChangeHook(), beforeChangeHook() (+3 more)
...
Cohesion: 0.11
Nodes (19): perspective_note, perspective_px, requirement, stage, container, preset, purpose, title (+11 more)
...
Cohesion: 0.11
Nodes (18): dependencies, @fontsource/material-symbols-outlined, next, react, react-dom, devDependencies, @types/node, @types/react (+10 more)

### Community 109 - "Module Group 109"
Cohesion: 0.12
Nodes (18): Multi-tenant Headless CMS Feature Specification, Multi-tenant Headless CMS Implementation Tasks, Tenant Management Implementation Plan, Tenant Onboarding Quickstart Guide, Domain Mapping Strategy, Tenant Management Technical Decisions and Rationale, Soft Delete and Archiving Strategy, Tenant Management Feature Specification (+10 more)
...
Cohesion: 0.13
Nodes (9): metadata, ContentItem, Tenant, ../../lib/cms, ../styles/global.css, ../layouts/Layout.astro, fetchPortfolioItems(), fetchProjectBySlug() (+1 more)

### Community 135 - "Module Group 135"
Cohesion: 0.12
Nodes (15): dependencies, astro, @astrojs/node, @fontsource/material-symbols-outlined, devDependencies, typescript, name, private (+7 more)

### Community 136 - "Module Group 136"
Cohesion: 0.12
Nodes (16): easing, entry_blur_px, entry_direction, entry_offset_px, entry_scale, exit_blur_px, exit_easing, exit_y_px (+8 more)
...
Cohesion: 0.12
Nodes (16): between_phrases_ms, easing, entry_blur_px, entry_offset_y_px, entry_scale, exit_blur_px, exit_duration_ms, exit_easing (+8 more)
...
Cohesion: 0.12
Nodes (16): build, easing, entry_blur_px, entry_direction, entry_offset_px, entry_scale, exit_blur_px, exit_easing (+8 more)

### Community 142 - "Module Group 142"
Cohesion: 0.12
Nodes (16): build, between_phrases_ms, easing, entry_blur_px, entry_offset_y_px, entry_scale, exit_blur_px, exit_duration_ms (+8 more)

### Community 143 - "Module Group 143"
Cohesion: 0.18
Nodes (8): ExternalAppTool, MarketplaceService, Orchestrates marketplace app registration and tool creation., LangChain Tool wrapper for 3rd-party marketplace apps.     Integrates pybreaker, BaseTool, JWTClaims, MarketplaceCircuitBreaker, Story 4: Circuit Breaker Policy     Trips after 3 failures, >5000ms timeout logi

### Community 144 - "Module Group 144"
Cohesion: 0.15
Nodes (15): BaseSettings, Configuration management for the AI Agent Service. Uses pydantic-settings to loa, Application settings., Settings, Unit tests for configuration loading., Verify that settings can be loaded from environment variables., Verify default values when environment is empty., Verify that ENVIRONMENT can be loaded from the environment. (+7 more)

### Community 145 - "Module Group 145"
Cohesion: 0.23
Nodes (10): BOTTOM_NAV_LINKS, CONTENT_SUB_LINKS, MAIN_NAV_LINKS, NavigationItem, TEMPLATE_SUB_LINKS, Nav(), COLLECTION_CTA_MAP, CtaConfig (+2 more)

### Community 146 - "Module Group 146"
Cohesion: 0.13
Nodes (14): id, portable_spec, description, display_name, id, inspiration, signature_easing, swap (+6 more)
...
Cohesion: 0.16
Nodes (15): to, duration_ms, easing, scaled_duration_ms, scaled_stagger_ms, source_duration_ms, source_stagger_ms, stagger_ms (+7 more)
...
Cohesion: 0.13
Nodes (15): easing, scaled_duration_ms, source_duration_ms, easing, scaled_duration_ms, source_duration_ms, easing, scaled_duration_ms (+7 more)

### Community 159 - "Module Group 159"
Cohesion: 0.13
Nodes (15): delay_step_ms, easing, scaled_duration_ms, source_duration_ms, easing, scaled_duration_ms, scaled_stagger_ms, source_duration_ms (+7 more)
...
Cohesion: 0.14
Nodes (14): scaled_duration_ms, scaled_stagger_ms, source_duration_ms, source_stagger_ms, scaled_duration_ms, scaled_stagger_ms, source_duration_ms, source_stagger_ms (+6 more)

### Community 164 - "Module Group 164"
Cohesion: 0.14
Nodes (14): phrases, sample, default_policy, loop_policy, showcase_samples, asset, key, showcase (+6 more)
...
Cohesion: 0.14
Nodes (13): files, .gemini/commands/speckit.analyze.toml, .gemini/commands/speckit.checklist.toml, .gemini/commands/speckit.clarify.toml, .gemini/commands/speckit.constitution.toml, .gemini/commands/speckit.implement.toml, .gemini/commands/speckit.plan.toml, .gemini/commands/speckit.specify.toml (+5 more)

### Community 175 - "Module Group 175"
Cohesion: 0.15
Nodes (13): title_filter, title_transform, word_animation_properties, before_enter, before_exit, shared-slide-opacity-stage, algorithm, frame_materialization (+5 more)

### Community 176 - "Module Group 176"
Cohesion: 0.27
Nodes (6): POST(), POST(), POST(), isRateLimited(), userRequestCache, GET()
...
Cohesion: 0.15
Nodes (13): title_filter, title_transform, word_animation_properties, before_enter, before_exit, algorithm, frame_materialization, id (+5 more)
...
Cohesion: 0.23
Nodes (8): drafting_service(), MockDraftingGraph, test_generate_draft_stream_bootstrap_flow_with_matching(), test_generate_draft_stream_conversational_no_healing(), test_generate_draft_stream_self_healing(), test_generate_draft_stream_tenant_mismatch(), test_generate_draft_stream_yields_events(), test_generate_draft_with_style_modifier()

### Community 200 - "Module Group 200"
Cohesion: 0.24
Nodes (11): Any, RunnableConfig, call_drafting_llm(), DraftingState, execute_drafting_tools(), StateGraph for AI Content Drafting workflow using LangGraph., Custom executor node to securely run tools and catch execution errors., Conditional routing edge checking for pending tool calls. (+3 more)

### Community 201 - "Module Group 201"
Cohesion: 0.20
Nodes (9): Any, Config, ContentDraft, DraftField, ContentDraft domain model for AI-generated content drafts.  T012 - Implement Pyd, A single field in a content draft.     Can represent a simple text field or a co, Domain entity representing an AI-generated draft of a content item., Helper to retrieve a field value by name. (+1 more)

### Community 202 - "Module Group 202"
Cohesion: 0.17
Nodes (11): ContentItem, Tenant, Args, ArticlePage(), generateMetadata(), parseTemplateHtml(), fetchActiveTemplateForSite(), fetchArticleBySlug() (+3 more)

### Community 203 - "Module Group 203"
Cohesion: 0.21
Nodes (12): create_deep_agent, Deep Agents Framework, CompositeBackend, FilesystemBackend, StateBackend, StoreBackend, HumanInTheLoopMiddleware, SubAgentMiddleware (+4 more)

### Community 204 - "Module Group 204"
Cohesion: 0.17
Nodes (12): cancellation, completion, easing, import_statement, install, keyframe_shape, renderer_notes, start_animation (+4 more)

### Community 205 - "Module Group 205"
Cohesion: 0.17
Nodes (12): motion, cancellation, completion, easing, import_statement, install, keyframe_shape, renderer_notes (+4 more)
...
Cohesion: 0.17
Nodes (11): id, portable_spec, custom_renderer, description, display_name, id, inspiration, signature_easing (+3 more)
...
Cohesion: 0.06
Nodes (37): Command, Common Fixes, Designing a LangGraph application, Edges, Error Handling, Nodes, Running Graphs: Invoke and Stream, Send API (+29 more)

### Community 246 - "Module Group 246"
Cohesion: 0.09
Nodes (23): Specification Analysis Workflow, Unit Tests for English, Sequential Questioning Loop Workflow, Constitution Template Management Workflow, Branch Numbering Mode, Create Feature Branch, Environment Variable Override, Execution (+15 more)

### Community 247 - "Module Group 247"
Cohesion: 0.04
Nodes (42): Assumptions, Edge Cases, Feature Specification: Template Deployment History, Functional Requirements, Key Entities *(include if feature involves data)*, Measurable Outcomes, Requirements *(mandatory)*, Success Criteria *(mandatory)* (+34 more)

### Community 248 - "Module Group 248"
Cohesion: 0.13
Nodes (13): Refines an existing draft by delegating to RefineService., Generates a content draft using a streaming LLM.         Yields events for expla, extract_json_from_text(), handle_graph_stream(), Unified handler for LangGraph astream_events, processing chunks, field detection, Extracts and parses JSON from a text block, handling markdown blocks and raw str, Any, AsyncSession (+5 more)

### Community 249 - "Module Group 249"
Cohesion: 0.24
Nodes (11): Astro Portfolio Starter README, Content Authoring Service, Self-Healing Output Parsing, Content Management Engine, Content Authoring Service (AI Microservice), Content Management Engine (CMS Monolith), Postgres-Backed Sliding-Window Rate Limiting, Single-User Session Locking & Recovery (+3 more)
...
Cohesion: 0.20
Nodes (9): AgentExecutionState, Domain State Definitions for LangGraph agent workflows., State tracking across content schema generation and drafting workflows., StateGraph for autonomous and self-correcting content schema generation., State tracking across the schema generation graph workflow., Decides whether to retry schema generation or exit., SchemaState, should_continue_schema() (+1 more)
...
Cohesion: 0.18
Nodes (10): id, portable_spec, description, display_name, id, inspiration, signature_easing, target (+2 more)

### Community 255 - "Module Group 255"
Cohesion: 0.18
Nodes (11): if_motion_feels_too_tall, if_readability_drops, swap, entry_condition, fallback, switch_order, verification, micro_delay_ms (+3 more)
...
Cohesion: 0.18
Nodes (11): if_phrase_feels_too_slow, if_push_is_too_subtle, swap, entry_condition, fallback, switch_order, verification, micro_delay_ms (+3 more)

### Community 264 - "Module Group 264"
Cohesion: 0.18
Nodes (11): easing, scaled_duration_ms, source_duration_ms, easing, scaled_duration_ms, source_duration_ms, timing, first_word (+3 more)
...
Cohesion: 0.18
Nodes (11): if_total_swap_is_too_long, if_words_stack_visibly, swap, entry_condition, fallback, switch_order, verification, micro_delay_ms (+3 more)
...
Cohesion: 0.18
Nodes (11): if_drop_is_too_subtle, if_phrase_feels_too_slow, swap, entry_condition, fallback, switch_order, verification, micro_delay_ms (+3 more)
...
Cohesion: 0.24
Nodes (3): GET(), TenantResolutionResult, TenantService

### Community 301 - "Module Group 301"
Cohesion: 0.18
Nodes (11): if_phrase_feels_too_slow, if_push_is_too_subtle, entry_condition, fallback, switch_order, verification, swap, micro_delay_ms (+3 more)

### Community 302 - "Module Group 302"
Cohesion: 0.18
Nodes (11): if_drop_is_too_subtle, if_phrase_feels_too_slow, entry_condition, fallback, switch_order, verification, swap, micro_delay_ms (+3 more)

### Community 303 - "Module Group 303"
Cohesion: 0.20
Nodes (9): config, customAgent, systemPromptConfig, systemPromptSections, toolNames, description, hidden, name (+1 more)

### Community 304 - "Module Group 304"
Cohesion: 0.40
Nodes (3): AI Copilot application service.  Handles localized section editing for the CMS r, Apply an AI edit instruction to a content section.          Args:             co, UUID

### Community 305 - "Module Group 305"
Cohesion: 0.20
Nodes (9): max, min, mode, website-default, gap_ms, hold_ms, initial_delay_ms, speed_multiplier (+1 more)

### Community 306 - "Module Group 306"
Cohesion: 0.27
Nodes (10): duration_ms, easing, from, stagger_ms, from, blur_px, opacity, scale (+2 more)
...
Cohesion: 0.20
Nodes (10): content_replacement, coordinate_space, fill_behavior, renderer, stagger_mode, target, transform_order, y_travel_multiplier (+2 more)

### Community 310 - "Module Group 310"
Cohesion: 0.20
Nodes (10): if_glyphs_collide, if_motion_feels_slow, swap, entry_condition, fallback, switch_order, verification, mode (+2 more)
...
Cohesion: 0.20
Nodes (10): if_copy_is_long, if_overlap_looks_heavy, swap, entry_condition, fallback, switch_order, verification, mode (+2 more)

### Community 313 - "Module Group 313"
Cohesion: 0.22
Nodes (9): do_run_migrations(), Alembic migrations environment configuration supporting async engines. Satisfies, Run migrations in 'offline' mode., Synchronous migrations runner within the connection context., Create async engine and run migrations online., Run migrations in 'online' mode using asyncio., run_async_migrations(), run_migrations_offline() (+1 more)

### Community 314 - "Module Group 314"
Cohesion: 0.20
Nodes (7): catalog, query, rawQuery, results, specsDir, terms, visibleOrder
...
Cohesion: 0.27
Nodes (10): from, exit, duration_ms, easing, from, stagger_ms, blur_px, opacity (+2 more)
...
Cohesion: 0.39
Nodes (3): createMockTenant(), createMockUser(), POST()

### Community 319 - "Module Group 319"
Cohesion: 0.15
Nodes (12): Any, HTTPAuthorizationCredentials, Internal signature and secret verification for service-to-service communication., Validate the internal service-to-service secret header in a timing-safe manner., Verifies the HS256 Marketplace JWT.     Returns the decoded claims (tenant_id, a, require_internal_secret(), verify_marketplace_token(), test_circuit_breaker_trips() (+4 more)

### Community 320 - "Module Group 320"
Cohesion: 0.22
Nodes (8): compilerOptions, module, moduleResolution, resolveJsonModule, skipLibCheck, strict, target, extends

### Community 321 - "Module Group 321"
Cohesion: 0.27
Nodes (6): BuildingBlockWorkspace(), BlockElement, BuildingBlockWorkspaceClient(), BlockElement, compileBlockSchema(), flattenElements()
...
Cohesion: 0.39
Nodes (4): DraftingSessions, capVersionsHook(), refreshActivityHook(), validateLockHook()

### Community 324 - "Module Group 324"
Cohesion: 0.22
Nodes (9): scaled_duration_ms, scaled_stagger_ms, source_duration_ms, source_stagger_ms, timing, exit, total_formulas, enter_total_ms (+1 more)

### Community 325 - "Module Group 325"
Cohesion: 0.22
Nodes (9): scaled_duration_ms, scaled_stagger_ms, source_duration_ms, source_stagger_ms, timing, enter, total_formulas, enter_total_ms (+1 more)
...
Cohesion: 0.31
Nodes (9): from, duration_ms, from, stagger_ms, blur_px, opacity, scale, y_px (+1 more)
...
Cohesion: 0.05
Nodes (38): API Contracts: CMS Engine — Drafting Proxy & Session Management, DELETE /api/ai-drafting/sessions/:id/lock, Error Responses, Error Responses, Error Responses, Error Responses, Error Responses, Error Responses (+30 more)
...
Cohesion: 0.15
Nodes (7): Documentation Structure, License, Payload Skill for AI Coding Agents, Resources, Usage, What's Included, Custom REST API Endpoints
...
Cohesion: 0.22
Nodes (8): custom_renderer, description, display_name, id, inspiration, signature_easing, target, usage_notes

### Community 342 - "Module Group 342"
Cohesion: 0.31
Nodes (5): MockDraftingGraph, refine_service(), test_refine_draft_stream_tenant_mismatch(), test_refine_draft_stream_yields_events(), test_refine_draft_with_style_modifier()

### Community 343 - "Module Group 343"
Cohesion: 0.25
Nodes (8): AI Agent Bounded Context, AIAgentSession Entity, CMS Bounded Context, 001 Multi-tenant Headless CMS Plan, CMS Quickstart Guide, Decision: Inter-Service Communication, Decision: Hybrid Language Stack, Decision: Logical Multi-Tenancy

### Community 344 - "Module Group 344"
Cohesion: 0.32
Nodes (7): CopilotService, copilot_service(), Unit tests for the CopilotService., Verify that edit_section invokes the LLM with correct prompts., Verify that edit_section wraps exceptions in RuntimeError., test_edit_section_handles_runtime_error(), test_edit_section_invokes_llm()
...
Cohesion: 0.07
Nodes (28): 1. Architectural Blueprint, 1. Create a Tenant API Key, 1. `draft_content`, 1. Environment Secrets Configuration, 1. WSL 2 Next.js Turbopack Hangs / deadlocks, 2. `chat_agent`, 2. Configure Claude Desktop, 2. Launch the Local Infrastructure & Services (+20 more)
...
Cohesion: 0.27
Nodes (9): TestClient, client(), Integration tests for the /api/ai/template-builder/generate endpoint. Specifical, Happy path for template generation., In development environment, detailed error messages should be exposed., In production environment, detailed error messages should NOT be exposed., test_generate_template_failure_development_exposes_details(), test_generate_template_failure_production_hides_details() (+1 more)

### Community 354 - "Module Group 354"
Cohesion: 0.29
Nodes (6): AsyncSession, get_db(), get_db_checkpointer(), SQLAlchemy database setup and session helpers. Satisfies T004 / T005b., Dependency to obtain a new database session., Asynchronous context manager returning the AsyncPostgresSaver checkpointer conne
...
Cohesion: 0.17
Nodes (8): Credentials, Discovery, Install, Langfuse CLI Reference, Tips, Feedback Form Structure, Skill Feedback, Submitting

### Community 361 - "Module Group 361"
Cohesion: 0.25
Nodes (7): description, display_name, id, inspiration, signature_easing, target, usage_notes

### Community 362 - "Module Group 362"
Cohesion: 0.29
Nodes (7): Rate Limiting Strategy, AIRateLimits Collection, JWT Token Generation Endpoint, JWTTokens Collection, TenantApps Collection, FastAPI AI Tool Circuit Breaker, MFE Error Boundary

### Community 363 - "Module Group 363"
Cohesion: 0.14
Nodes (19): client(), Integration tests to verify that exception/error details are not exposed to clie, In production environment, draft exception details should be replaced with a gen, In development environment, refine exception details should be exposed in the st, In production environment, refine exception details should be replaced with a ge, In development environment, session message exception details should be exposed, In production environment, session message exception details should be replaced, In development environment, detailed template builder error messages should be e (+11 more)

### Community 364 - "Module Group 364"
Cohesion: 0.29
Nodes (7): generic-stagger, canonical_loop_pseudocode, id, loop_algorithm, loop_invariants, required_dom, summary
...
Cohesion: 0.29
Nodes (7): duration_ms, easing, scaled_duration_ms, source_duration_ms, stagger_ms, exit, exit
...
Cohesion: 0.29
Nodes (7): unit, backface_visibility, display, line_display, transform_origin, white_space, will_change
...
Cohesion: 0.29
Nodes (7): word_opacity_duration_ms, word_opacity_from, word_opacity_to, id, params, source, renderer
...
Cohesion: 0.12
Nodes (17): tenantAccess(), tenantReadAccess(), AIPromptHistory, BuildingBlocks, tenantDeliveryAccess(), HostedSites, JWTTokens, Media (+9 more)
...
Cohesion: 0.47
Nodes (6): Hermes AI Constitution, Hermes AI Headless CMS, Alexandria Design System, Content Authoring Service Microservice, Content Management Engine Monolith, Langfuse UI stack

### Community 405 - "Module Group 405"
Cohesion: 0.33
Nodes (5): Any, InjectedToolArg, LangChain tool for resolving and updating content type schemas in the CMS.  T016, Updates the structural definition (schema) of a content type in the CMS.      Us, schema_resolver()

### Community 406 - "Module Group 406"
Cohesion: 0.18
Nodes (10): kinetic-center-build, algorithm, id, required_measurements, summary, kinetic-top-build, algorithm, id (+2 more)

### Community 407 - "Module Group 407"
Cohesion: 0.53
Nodes (6): coordinate_space, filter, opacity, transform, frame_materialization, frame_materialization

### Community 408 - "Module Group 408"
Cohesion: 0.33
Nodes (6): fill, letter_spacing, opacity_default, scale_default, transform_order, frame_materialization

### Community 409 - "Module Group 409"
Cohesion: 0.53
Nodes (6): existing_word_push, exit_word, first_word, incoming_word_push, keyframe_recipe, keyframe_recipe

### Community 410 - "Module Group 410"
Cohesion: 0.47
Nodes (6): to, to, blur_px, opacity, scale, y_px
...
Cohesion: 0.33
Nodes (6): easing, scaled_duration_ms, scaled_stagger_ms, source_duration_ms, source_stagger_ms, enter_title
...
Cohesion: 0.18
Nodes (12): Chroma Vector Store, Complete RAG Pipeline, Document Loaders, FAISS Vector Store, InMemoryVectorStore, Pinecone Vector Store, RecursiveCharacterTextSplitter, Retrieval (+4 more)

### Community 415 - "Module Group 415"
Cohesion: 0.40
Nodes (3): EventBus, MarketplaceEventMap, MarketplaceEventName

### Community 418 - "Module Group 418"
Cohesion: 0.33
Nodes (4): catalog, specs, specsDir, visibleOrder
...
Cohesion: 0.40
Nodes (5): Destructive Schema Change Lock, Dynamic Content Validation Strategy, Optimistic Concurrency Control, validateFields, beforeChange hooks (ContentTypes)
...
Cohesion: 0.09
Nodes (22): [0.2.0] - 2026-05-17, [0.3.0] - 2026-05-17, [0.4.0] - 2026-05-23, 1. Core Data Models & Collections (`apps/content-management-engine/src/collections/`), 1. Core Data Models & Schema Extensions (`apps/content-management-engine/src/collections/`), 1. Core Data Models & Schema Extensions (`apps/content-management-engine/src/collections/`), 2. Services & API Resolution Endpoints (`apps/content-management-engine/src/services/` & `apps/content-management-engine/src/app/`), 2. Services, APIs & Proxy Routes (+14 more)

### Community 425 - "Module Group 425"
Cohesion: 0.40
Nodes (5): branches_on_swap_mode, note, uses_micro_delay_ms, uses_overlap_ms, current_site_swap_support
...
Cohesion: 0.40
Nodes (5): stagger_rank_algorithms, center-out, edges-in, normal, reverse

### Community 428 - "Module Group 428"
Cohesion: 0.09
Nodes (22): Animate Text Spec Format, `build`, `custom_renderer`, `effect.showcase.content`, `effect.showcase.content_usage`, `effect.showcase.engine_notes`, `effect.showcase.library_adapters`, `effect.showcase.library_selection` (+14 more)

### Community 429 - "Module Group 429"
Cohesion: 0.09
Nodes (21): Dependencies & Execution Order, Format: `[ID] [P?] [Story] Description`, Implementation for User Story 1, Implementation Strategy, Incremental Delivery, MVP First (User Story 1 Only), Parallel Example: User Story 1, Parallel Opportunities (+13 more)
...
Cohesion: 0.10
Nodes (19): Dependencies & Execution Order, Format: `[ID] [P?] [Story] Description`, Implementation for User Story 1, Implementation for User Story 2, Implementation for User Story 3, Implementation Strategy, MVP First (User Story 1 Only), Parallel Opportunities (+11 more)

### Community 437 - "Module Group 437"
Cohesion: 0.10
Nodes (19): 1. Dynamic Langfuse Prompt Catalog, 1. `POST /api/ai/draft` (SSE Stream), 1. Python Environment Setup, 2. Environment Configuration, 2. `POST /api/ai/refine` (SSE Stream), 2. Self-Healing Output Parsing, 3. Native Agent Tools, 3. `POST /api/ai/generate-schema` (+11 more)
...
Cohesion: 0.40
Nodes (4): Aurelian Spectre V12 Premium Showcase Image, dirname, filename, seed()
...
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, animate-text

### Community 444 - "Module Group 444"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, deep-agents-core

### Community 445 - "Module Group 445"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, deep-agents-memory

### Community 446 - "Module Group 446"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, deep-agents-orchestration

### Community 447 - "Module Group 447"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, framework-selection

### Community 448 - "Module Group 448"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, langchain-dependencies

### Community 449 - "Module Group 449"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, langchain-fundamentals

### Community 450 - "Module Group 450"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, langchain-middleware

### Community 451 - "Module Group 451"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, langchain-rag

### Community 452 - "Module Group 452"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, langfuse

### Community 453 - "Module Group 453"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, langgraph-cli

### Community 454 - "Module Group 454"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, langgraph-fundamentals

### Community 455 - "Module Group 455"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, langgraph-human-in-the-loop

### Community 456 - "Module Group 456"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, langgraph-persistence

### Community 457 - "Module Group 457"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, managed-deep-agents

### Community 458 - "Module Group 458"
Cohesion: 0.40
Nodes (5): computedHash, skillPath, source, sourceType, payload
...
Cohesion: 0.40
Nodes (5): swarm, computedHash, skillPath, source, sourceType
...
Cohesion: 0.50
Nodes (3): renderer_overrides, kinetic-center-build, visible_ids

### Community 464 - "Module Group 464"
Cohesion: 0.67
Nodes (3): spring-scale-in, sample, samples
...
Cohesion: 0.11
Nodes (18): 1. Architectural Overview, 2. Bounded Contexts & DDD (FastAPI), 3. Data Model (Payload CMS), 4. Security & Access Control, 5. Technical Implementation Details, 6. Test-First Strategy (TDD), 7. Alexandria Design Compliance, FastAPI Middleware & Circuit Breaker (+10 more)

### Community 469 - "Module Group 469"
Cohesion: 0.05
Nodes (39): Commands, Full config with all keys, Gotchas, Installation, Key reference, `langgraph build`, `langgraph deploy`, `langgraph deploy delete` (+31 more)

### Community 470 - "Module Group 470"
Cohesion: 0.11
Nodes (18): Architecture Overview, Constitution (Source of Truth), Content Authoring Service (apps/content-authoring-service), Content Management Engine (apps/content-management-engine), Custom Admin Views, Design System, Development Commands, Hermes AI — Agent Guidelines (+10 more)

### Community 473 - "Module Group 473"
Cohesion: 0.50
Nodes (4): Alexandria Editorial Layout Style, The Art of Velocity Hero Article, Aurelian Discovery V2 Template Thumbnail, The Automotive Journal Template

### Community 474 - "Module Group 474"
Cohesion: 0.83
Nodes (3): getInternalAuthHeaders(), getInternalSecret(), verifyInternalSecret()
...
Cohesion: 0.50
Nodes (3): bypass_auth_verification(), Conftest configuration for pytest in AI Agent Service. Satisfies T003., Automatically bypass internal secret verification for all tests by default.

### Community 479 - "Module Group 479"
Cohesion: 0.50
Nodes (3): image_generator(), LangChain tool for generating images using AI.  T038 - Implement image_generator, Generates a professional image based on a prompt.      You MUST call this tool f

### Community 480 - "Module Group 480"
Cohesion: 1.00
Nodes (3): LangChain Image Generation Tool, POST /api/ai/download-image (CMS Proxy), POST /api/ai/generate-image (AI Service)

### Community 481 - "Module Group 481"
Cohesion: 1.00
Nodes (3): SSE Streaming Architecture, POST /api/ai/draft (CMS Proxy), POST /api/ai/draft (AI Service)

### Community 482 - "Module Group 482"
Cohesion: 0.67
Nodes (3): A2UI Component Schema, API Key Validation Contract, MCPSessionContext Ephemeral Registry
...
Cohesion: 0.67
Nodes (3): bottom-up-letters, sample, samples

### Community 486 - "Module Group 486"
Cohesion: 0.67
Nodes (3): fade-through, sample, samples

### Community 487 - "Module Group 487"
Cohesion: 0.67
Nodes (3): focus-blur-resolve, sample, samples

### Community 488 - "Module Group 488"
Cohesion: 0.67
Nodes (3): kinetic-center-build, phrases, sample

### Community 489 - "Module Group 489"
Cohesion: 0.67
Nodes (3): line-by-line-slide, sample, samples

### Community 490 - "Module Group 490"
Cohesion: 0.67
Nodes (3): mask-reveal-up, sample, samples

### Community 491 - "Module Group 491"
Cohesion: 0.67
Nodes (3): micro-scale-fade, sample, samples

### Community 492 - "Module Group 492"
Cohesion: 0.67
Nodes (3): per-character-rise, sample, samples

### Community 493 - "Module Group 493"
Cohesion: 0.67
Nodes (3): per-word-crossfade, sample, samples

### Community 494 - "Module Group 494"
Cohesion: 0.67
Nodes (3): scale-down-fade, sample, samples

### Community 495 - "Module Group 495"
Cohesion: 0.67
Nodes (3): shared-axis-y, sample, samples

### Community 496 - "Module Group 496"
Cohesion: 0.67
Nodes (3): shared-axis-z, sample, samples

### Community 497 - "Module Group 497"
Cohesion: 0.67
Nodes (3): shimmer-sweep, sample, samples

### Community 498 - "Module Group 498"
Cohesion: 0.67
Nodes (3): short-slide-down, phrases, sample

### Community 499 - "Module Group 499"
Cohesion: 0.67
Nodes (3): short-slide-right, sample, samples
...
Cohesion: 0.67
Nodes (3): typewriter, sample, samples

### Community 509 - "Module Group 509"
Cohesion: 0.67
Nodes (3): POST /api/ai/refine (CMS Proxy), POST /api/ai/refine-all (CMS Proxy), POST /api/ai/refine (AI Service)

### Community 512 - "Module Group 512"
Cohesion: 0.11
Nodes (18): Array, Blocks, Collapsible (Layout), Conditional Fields, Field Type Guards, Join Fields, Payload Field Types Reference, Radio (+10 more)

### Community 516 - "Module Group 516"
Cohesion: 0.11
Nodes (18): Checklist, Common Issues, Decision Tree, Detect Existing Tracing, Langfuse Prompt Migration, Link Methods, Migration Flow, Out of Scope (+10 more)

### Community 556 - "Module Group 556"
Cohesion: 0.12
Nodes (16): Dependencies & Execution Order, Implementation for User Story 1, Implementation for User Story 2, Implementation for User Story 3, Implementation Strategy, Incremental Delivery, MVP First (User Story 1 & 2), Parallel Opportunities (+8 more)

### Community 565 - "Module Group 565"
Cohesion: 0.12
Nodes (16): 1. Create a DraftingSession, 2. Start AI Draft Generation, 3. Test Inline Refinement, 4. Promote Draft to ContentItem, CMS Engine (apps/content-management-engine), CMS Engine — New Collections, Content Authoring Service (apps/content-authoring-service), Content Authoring Service — New Domain Context (+8 more)

### Community 567 - "Module Group 567"
Cohesion: 0.50
Nodes (3): Code Reviewer Prompt Template, Example Output, requesting-code-review SKILL.md

### Community 587 - "Module Group 587"
Cohesion: 0.25
Nodes (7): Animate Text, Bundled Resources, Notes, Optional Helper Scripts, Translation Rules, When To Use, Workflow

### Community 612 - "Module Group 612"
Cohesion: 0.13
Nodes (14): 1. Content Management Engine (CMS Monolith), 1. Server-Sent Events (SSE) content drafting, 2. Single-User Session Locking & Recovery, 2. Template Builder Engine, 3. Content Authoring Service (AI Microservice), 3. Distributed Tracing & Prompt Management (Langfuse), 4. Agent-to-Agent (A2A) & Model Context Protocol (MCP) Integration, 4. Postgres-Backed Sliding-Window Rate Limiting (+6 more)

### Community 634 - "Module Group 634"
Cohesion: 0.17
Nodes (12): 1. Langfuse API via CLI, 2. Langfuse Documentation, 2a. Documentation Index (llms.txt), 2b. Fetch Individual Pages as Markdown, 2c. Search Documentation, Core Principles, Credentials, Detailed CLI Reference (+4 more)

### Community 636 - "Module Group 636"
Cohesion: 0.12
Nodes (16): Assumptions, Clarifications, Edge Cases, Feature Specification: A2A, MCP & A2UI Integration, Functional Requirements, Key Entities, Measurable Outcomes, Out of Scope (+8 more)

### Community 637 - "Module Group 637"
Cohesion: 0.12
Nodes (16): 1. Register a Global Application (Super Admin), 2. Install an App for a Tenant, 3. Generate a Secure Connection Token, 4. Integration Technical Details, Architecture & Conventions, Building for Production, Development, Environment Variables (+8 more)
...
Cohesion: 0.12
Nodes (15): Assumptions, Clarifications, Edge Cases, Feature Specification: Multi-tenant Headless CMS, Functional Requirements, Key Entities, Measurable Outcomes, Requirements *(mandatory)* (+7 more)

### Community 660 - "Module Group 660"
Cohesion: 0.06
Nodes (32): Active Subscription Required, Async Operations Impact, Avoid N+1 Queries, Basic Authenticated Collection, Configuration Templates, Context-Aware Access Patterns, createOrgScopedAccess, createRoleBasedAccess (+24 more)

### Community 666 - "Module Group 666"
Cohesion: 0.12
Nodes (15): Agent Rules, Architecture at a Glance, Design System ("Alexandria"), Development Commands, graphify, Hermes CMS — Gemini Agent Context, Key Tech Versions, Non-Negotiable Principles (from Constitution) (+7 more)
...
Cohesion: 0.13
Nodes (14): Assumptions, Clarifications, Edge Cases, Feature Specification: Tenant Management, Functional Requirements, Key Entities *(include if feature involves data)*, Measurable Outcomes, Requirements *(mandatory)* (+6 more)

### Community 674 - "Module Group 674"
Cohesion: 0.13
Nodes (14): Assumptions, Clarifications, Feature Specification: Define Content Types, Functional Requirements, Key Entities *(include if feature involves data)*, Measurable Outcomes, Non-Functional Requirements, Requirements *(mandatory)* (+6 more)

### Community 677 - "Module Group 677"
Cohesion: 0.22
Nodes (9): Auth Collection, Basic Collection, Document Status, Draft API Usage, Globals, Live Preview, Payload Collections Reference, Upload Collection (+1 more)

### Community 678 - "Module Group 678"
Cohesion: 0.13
Nodes (14): R-001: Markdown-to-Lexical JSON Conversion, R-002: SSE Streaming Architecture (FastAPI → Next.js → Browser), R-003: LangChain Tool Calling for Image Generation, R-004: DraftingSession Locking & Lifecycle, R-005: Rate Limiting Strategy, R-006: Auto-Save Strategy for DraftingSession, R-007: Version Snapshot Strategy, R-008: StyleModifier Collection Design (+6 more)

### Community 679 - "Module Group 679"
Cohesion: 0.13
Nodes (14): Assumptions, Clarifications, Edge Cases, Feature Specification: Template Builder Engine, Functional Requirements, Key Entities, Measurable Outcomes, Requirements *(mandatory)* (+6 more)

### Community 680 - "Module Group 680"
Cohesion: 0.13
Nodes (14): API Contracts: Content Authoring Service — Content Drafting, Error Responses, Error Responses, Error Responses, Event Types, POST /api/ai/draft, POST /api/ai/generate-image, POST /api/ai/refine (+6 more)

### Community 681 - "Module Group 681"
Cohesion: 0.13
Nodes (14): 1. Connection Establishment (SSE Endpoint), 2. JSON-RPC Client Messaging Endpoint, 3. SSE Stream Downstream Events, Authentication Rules, Contract: SSE MCP Transport API, Event: `endpoint`, Event: `message`, Example: Execute Tool Request (+6 more)

### Community 682 - "Module Group 682"
Cohesion: 0.13
Nodes (14): AI Integration, Core Principles, Development Workflow, Governance, I. Multi-tenancy by Default, II. AI as a First-Class Citizen, III. API-First Content Delivery, IV. Test-First (NON-NEGOTIABLE) (+6 more)
...
Cohesion: 0.40
Nodes (5): Capability Guards, fieldHasMaxDepth, fieldIsVirtual, fieldShouldBeLocalized, fieldSupportsMany

### Community 687 - "Module Group 687"
Cohesion: 0.40
Nodes (5): fieldHasSubFields, fieldIsArrayType, fieldIsBlockType, fieldIsGroupType, Structural Guards
...
Cohesion: 0.13
Nodes (14): Best Practices, Both SDKs, Common Pitfalls, Correlating attributes (both SDKs), Dataset experiments (Python), JS/TS-specific, Key API Changes Reference, Langfuse SDK Upgrade Guide (+6 more)

### Community 690 - "Module Group 690"
Cohesion: 0.15
Nodes (12): 1. Database Collections (Payload CMS), 2. JWT Generation Endpoint (Payload CMS), 3. Admin UI Customization (Payload CMS), 4. Frontend Micro-frontend Architecture (Next.js), 5. FastAPI AI Service Integration, Feature Spec: Hermes App Marketplace (JWT Implementation), Implementation Plan, Story 1: Scoped Marketplace Token Generation (+4 more)

### Community 691 - "Module Group 691"
Cohesion: 0.15
Nodes (12): Assumptions, Edge Cases, Feature Specification: Template Builder Agent, Functional Requirements, Key Entities *(include if feature involves data)*, Measurable Outcomes, Requirements *(mandatory)*, Success Criteria *(mandatory)* (+4 more)

### Community 692 - "Module Group 692"
Cohesion: 0.15
Nodes (12): AISuggestIndicator, ChatPanel, Component Hierarchy, Component Specifications, DraftingWorkspace, FloatingAIBar, Keyboard Shortcuts, RecoveryDialog (+4 more)

### Community 693 - "Module Group 693"
Cohesion: 0.15
Nodes (13): 1. Local API Access Control (CRITICAL), 2. Transaction Failures in Hooks, 3. Infinite Hook Loops, 4. Bypassing Type Safety with "as any" (Out-of-Sync Union Slugs), Minimal Config, Payload Application Development, Project Structure, Quick Reference (+5 more)

### Community 694 - "Module Group 694"
Cohesion: 0.22
Nodes (7): fieldIsSidebar, groupHasName, Layout Guards, Payload Field Type Guards Reference, Tab & Group Guards, tabHasName, Type Preservation
...
Cohesion: 0.17
Nodes (11): 1. DraftingSession (New — Payload CMS Collection), 2. StyleModifier (New — Payload CMS Collection), 3. AIAuditLog (New — Payload CMS Collection), 4. AISuggestion (Ephemeral — Client-Side State), 5. AIRateLimits (New — Payload CMS Collection), 6. ContentDraft (Value Object — AI Service Domain), 7. AIAgentSession (New — AI Microservice SQLAlchemy Model), Data Model: AI Content Drafting (+3 more)

### Community 697 - "Module Group 697"
Cohesion: 0.17
Nodes (11): Adding New Icons, Astro Portfolio Starter, Available Size Classes, Basic Usage, Common Icons, Complete Icon Library, Environment Variables, Fetching Content (+3 more)

### Community 698 - "Module Group 698"
Cohesion: 0.17
Nodes (11): Adding New Icons, Available Size Classes, Basic Usage, Common Icons, Complete Icon Library, Environment Variables, Fetching Content, Font Features (+3 more)
...
Cohesion: 0.18
Nodes (10): AIAgentSession (Aggregate Root), Bounded Contexts, Collections (CMS Context - Payload CMS), ContentItem, ContentType, Data Model, Entities (AI Agent Context - AI Microservice), Relationships (+2 more)

### Community 701 - "Module Group 701"
Cohesion: 0.18
Nodes (10): 1. External Connection & Session Context, 2. API Key Validation Contract (Next.js ↔ FastAPI), 3. A2UI / AGUI Component Schema, Data Model: A2A, MCP & A2UI Integration, Ephemeral Session Registry, Example: Alexandria Styled Metric Card, Schema Spec (Alexandria Component), Validation Request (+2 more)

### Community 702 - "Module Group 702"
Cohesion: 0.18
Nodes (10): 422 Unprocessable Entity, 503 Service Unavailable, Authentication, Contract: Schema Generation API, Endpoint: GET /api/ai/sessions/{session_id}, Endpoint: POST /api/ai/generate-schema, Error Responses, Request Payload (JSON) (+2 more)
...
Cohesion: 0.25
Nodes (7): Collection Hooks, Date Field Auto-Set, Field Hooks, Hook Context, Hook Patterns Best Practices, Next.js Revalidation with Context Control, Payload Hooks Reference
...
Cohesion: 0.20
Nodes (9): 1. Visual Response Payload, 2. Component Layout Schema, 3. Style Mapping to Alexandria Tokens, Card Node (`card`), Chart Node (`chart`), Contract: Agent-to-UI (A2UI) custom DSL, Form Node (`form`), Graceful Degradation and Client Fallbacks (+1 more)
...
Cohesion: 0.20
Nodes (9): 401 Unauthorized, 403 Forbidden, 404 Not Found, Contract: Tenant Resolution API, Endpoint: GET /api/tenants/resolve, Error Responses, Query Parameters, Request Headers (+1 more)

### Community 719 - "Module Group 719"
Cohesion: 0.20
Nodes (9): 1. Creating a Tenant, 2. Configuring Custom Domains, 3. White-Label Branding & Identity, 4. AI & Model Configurations (AI-First CMS), 5. Tenant-Scoped Style Modifiers (Custom Tones), 6. Tenant Status & Lifecycle States, 7. Impersonation (Super Admin Only), 8. Tenant Resolution API (+1 more)

### Community 720 - "Module Group 720"
Cohesion: 0.20
Nodes (9): Decision Guide, Deep Agents — Use when the task is open-ended and multi-dimensional, Framework Profiles, How it works in practice, LangChain — Use when the task is focused and self-contained, LangGraph — Use when you need to own the control flow, Mixing Layers, Quick Reference (+1 more)

### Community 721 - "Module Group 721"
Cohesion: 0.17
Nodes (11): Access Control in Local API, AND/OR Logic, GraphQL, Local API, Nested Properties, Payload Querying Reference, Performance Best Practices, Query Operators (+3 more)
...
Cohesion: 0.20
Nodes (9): 1. Distributed Tracing Flow, 2. Dynamic Prompt Management, A. Local-First Run (Apps locally, DB/Kafka in Docker — Recommended), Architecture, B. Full Containerized Stack (All services in Docker), Hermes AI — Headless CMS, Local Development Startup, Observability & Prompt Management (Langfuse) (+1 more)

### Community 724 - "Module Group 724"
Cohesion: 0.20
Nodes (9): Canonical Contract, Current Showcase Swap Semantics, Exact Site Reproduction, General Mapping, Implementation Notes, Layout-aware Effects, Stack Notes, Target Splitting (+1 more)
...
Cohesion: 0.17
Nodes (11): 1. Assess Current State, 2. Verify Baseline Requirements, 3. Explore Traces First, 4. Discover Additional Context Needs, 5. Guide to UI, Always Explain Why, Common Mistakes, Framework Integrations (+3 more)

### Community 744 - "Module Group 744"
Cohesion: 0.20
Nodes (9): Additional bundled patterns not on the website, Effect Families, Fast Rules, Layout-aware choreography, Per-character emphasis, Per-line editorial reveals, Per-word phrasing, Selection Guide (+1 more)

### Community 756 - "Module Group 756"
Cohesion: 0.22
Nodes (8): Complexity Tracking, Constitution Check, Documentation (this feature), Implementation Plan: Multi-tenant Headless CMS, Project Structure, Source Code (repository root), Summary, Technical Context

### Community 760 - "Module Group 760"
Cohesion: 0.22
Nodes (8): Complexity Tracking, Constitution Check, Documentation (this feature), Implementation Plan: Tenant Management, Project Structure, Source Code (repository root), Summary, Technical Context

### Community 761 - "Module Group 761"
Cohesion: 0.22
Nodes (8): Complexity Tracking, Constitution Check, Documentation (this feature), Implementation Plan: Define Content Types, Project Structure, Source Code (repository root), Summary, Technical Context

### Community 776 - "Community 776"
Cohesion: 0.22
Nodes (8): Complexity Tracking, Constitution Check, Documentation (this feature), Implementation Plan: AI Content Drafting, Project Structure, Source Code (repository root), Summary, Technical Context

### Community 777 - "Community 777"
Cohesion: 0.22
Nodes (8): Complexity Tracking, Constitution Check, Documentation (this feature), Implementation Plan: Template Builder Engine, Project Structure, Source Code (repository root), Summary, Technical Context

### Community 778 - "Community 778"
Cohesion: 0.22
Nodes (8): Complexity Tracking, Constitution Check, Documentation (this feature), Implementation Plan: A2A, MCP & A2UI Integration, Project Structure, Source Code (repository root), Summary, Technical Context

### Community 779 - "Community 779"
Cohesion: 0.22
Nodes (8): Complexity Tracking, Constitution Check, Documentation (this feature), Implementation Plan: Template Builder Agent, Project Structure, Source Code, Summary, Technical Context

### Community 780 - "Community 780"
Cohesion: 0.22
Nodes (8): Complexity Tracking, Constitution Check, Documentation (this feature), Implementation Plan: Template Deployment History, Project Structure, Source Code, Summary, Technical Context
...
Cohesion: 0.22
Nodes (8): Alexandria — High-End Editorial, Animations & Interactions, Colors, Components, Elevation, North Star: "The Digital Curator", Rules, Typography
...
Cohesion: 0.25
Nodes (7): 1. Create the Tenant, 2. Configure Branding, 3. Verify Access, Prerequisites, Quickstart: Tenant Onboarding, Steps, Troubleshooting

### Community 785 - "Community 785"
Cohesion: 0.25
Nodes (7): Decision 1: Domain Mapping Strategy, Decision 2: Soft Delete & Archiving, Decision 3: Audit Logging, Decision 4: Tenant Resolution API, Decision 5: Super Admin Impersonation, Needs Clarification (Resolved), Research: Tenant Management

### Community 786 - "Community 786"
Cohesion: 0.25
Nodes (7): AIAgentSession (AI service, port 5433), AIPromptHistory (CMS Monolith), Collections, ContentItems (updated), ContentTypes (updated), Data Model: Define Content Types, Relationships

### Community 787 - "Community 787"
Cohesion: 0.25
Nodes (7): 1. Create a Content Type via AI Prompt, 2. Refine the Suggested Fields Visually, 3. Publish and Lock the Content Type, 4. Author Content Conforming to the Schema, 5. Export Schema for Developers, Prerequisites, Quickstart: Define Content Types with AI Copilot

### Community 788 - "Community 788"
Cohesion: 0.25
Nodes (7): Decision 1: Dynamic Content Validation Strategy, Decision 2: AI Suggestion Self-Correction Loop, Decision 3: Preventing Destructive Schema Changes, Decision 4: Optimistic Concurrency Control, Decision 5: Exporting Formats, Needs Clarification (Resolved), Research: Define Content Types

### Community 789 - "Community 789"
Cohesion: 0.25
Nodes (7): Decision: Block Registry API, Decision: Builder UI, Decision: Data Resolution, Decision: Deployment Mechanism, Decision: Dnd-Kit Interaction & Collision Logic, Research: Template Builder Engine, Technical Context Resolution

### Community 790 - "Community 790"
Cohesion: 0.25
Nodes (8): 1. Alexandria Layout Offsets, 2. Preventing Double-Nesting Layout Shifts (18rem Sidebar Offset Bug), 3. The "Deep-Ancestor" Layout Reset Pattern, 4. Interactive UX & Accessibility Guidelines, 5. Custom View Verification Checklist, 6. Compiler Stability & Acyclic Build Prevention (CRITICAL WSL 2), 7. Seeding & Caching Stability Guardrails, Alexandria Layout & Admin UI Guardrails (CRITICAL)

### Community 791 - "Community 791"
Cohesion: 0.25
Nodes (8): Access Control with Type Safety, Basic Collection, Common Fields, Essential Patterns, Getting Payload Instance, Hook Example, Logger Usage, Query Example

### Community 792 - "Community 792"
Cohesion: 0.25
Nodes (8): Access Control Function Arguments, Collection Create, Collection Delete, Collection Read, Collection Update, Field Create, Field Read, Field Update
...
Cohesion: 0.29
Nodes (6): Implementation Tasks: Hermes App Marketplace, Phase 1: Payload CMS Collections & TDD Setup, Phase 2: JWT Generation Backend (TDD), Phase 3: Admin UI Enhancements (Alexandria Design), Phase 4: Frontend Micro-frontend Utilities (TDD), Phase 5: FastAPI AI Service Integration (DDD & TDD)

### Community 799 - "Community 799"
Cohesion: 0.29
Nodes (6): BlockInstance (Layout Row), BuildingBlocks, Data Model: Template Builder Engine, PageTemplates, Relationships, TemplateDeployments

### Community 800 - "Community 800"
Cohesion: 0.29
Nodes (6): 1. Register Building Blocks, 2. Create a Page Template, 3. Map Fields, 4. Deploy, 5. Fetch Hydrated Content, Quickstart: Template Builder Engine

### Community 801 - "Community 801"
Cohesion: 0.29
Nodes (6): 1. TemplateBuilderRequest (Input payload), 2. GeneratedContentType (Content Type Payload), 3. GeneratedPageTemplate (Page Template Payload), Data Model: Template Builder Agent, Entities, Relationships

### Community 802 - "Community 802"
Cohesion: 0.29
Nodes (6): 1. Configure Claude Desktop, 2. Invoke the Tool, Quickstart Guide: Template Builder Agent, Running Tests, Setup, Testing via MCP

### Community 803 - "Community 803"
Cohesion: 0.29
Nodes (6): Alternatives Considered, Decision: Implementation Strategy, Rationale, Research: Template Deployment History View, Testing Patterns, Unresolved Items

### Community 804 - "Community 804"
Cohesion: 0.29
Nodes (6): API Contracts, Content Delivery API (Read-only), `GET /api/content-items?where[tenant][equals]=<TenantId>&where[contentType][equals]=<TypeId>`, Management API (Internal/Editor Custom Endpoints), `POST /api/ai/copilot/edit`, `POST /api/ai/generate-schema`
...
Cohesion: 0.33
Nodes (5): Inter-Service Communication, Language/Version, Multi-Tenancy Approach, Primary Dependencies, Research & Decisions

### Community 813 - "Community 813"
Cohesion: 0.33
Nodes (5): AuditLogs, Collections, Data Model: Tenant Management, Relationships, Tenants

### Community 814 - "Community 814"
Cohesion: 0.33
Nodes (5): 1. Establish SSE Connection, 1. Local Stdio Integration with Claude Desktop, 2. Post a JSON-RPC Message, 2. Testing via SSE (HTTP Server-Sent Events), Quickstart: A2A & MCP Developer Integration

### Community 815 - "Community 815"
Cohesion: 0.33
Nodes (5): 1. Authentication & Tenant Retrieval, 2. Model Context Protocol (MCP) Transports, 3. Dynamic Tool Mapping, 4. Agent-Generated UI (AGUI/A2UI) custom DSL, Research: A2A, MCP & A2UI Integration

### Community 816 - "Community 816"
Cohesion: 0.33
Nodes (5): Specification Quality Checklist: A2A, MCP & A2UI Integration, Content Quality, Feature Readiness, Notes, Requirement Completeness

### Community 817 - "Community 817"
Cohesion: 0.33
Nodes (5): Specification Quality Checklist: AI Content Drafting, Content Quality, Feature Readiness, Notes, Requirement Completeness

### Community 818 - "Community 818"
Cohesion: 0.33
Nodes (5): Specification Quality Checklist: Define Content Types, Content Quality, Feature Readiness, Notes, Requirement Completeness

### Community 819 - "Community 819"
Cohesion: 0.33
Nodes (5): Specification Quality Checklist: Multi-tenant Headless CMS, Content Quality, Feature Readiness, Notes, Requirement Completeness

### Community 820 - "Community 820"
Cohesion: 0.33
Nodes (5): Specification Quality Checklist: Template Builder Agent, Content Quality, Feature Readiness, Notes, Requirement Completeness

### Community 821 - "Community 821"
Cohesion: 0.33
Nodes (5): Specification Quality Checklist: Template Builder Engine, Content Quality, Feature Readiness, Notes, Requirement Completeness

### Community 822 - "Community 822"
Cohesion: 0.33
Nodes (5): Specification Quality Checklist: Tenant Management, Content Quality, Feature Readiness, Notes, Requirement Completeness
...
Cohesion: 0.33
Nodes (5): 1. POST /api/ai/template-builder/generate, API Contract: Template Builder Agent, Endpoints, MCP Tool Interface, Tool: `convert_html_to_template`
...
Cohesion: 0.40
Nodes (4): Development Workflow, Prerequisites, Quickstart: Multi-tenant Headless CMS, Setup

### Community 837 - "Community 837"
Cohesion: 0.40
Nodes (4): API Contract: Block Registry, Error Response (400 Bad Request), Request Payload, Success Response (200 OK)

### Community 838 - "Community 838"
Cohesion: 0.50
Nodes (4): enter, duration_ms, easing, stagger_ms
...
Cohesion: 0.50
Nodes (3): Access Control, Data Model: Template Deployments, Entity: TemplateDeployment

### Community 845 - "Community 845"
Cohesion: 0.50
Nodes (3): Features, Quickstart: Deployment History, Viewing the History

### Community 847 - "Community 847"
Cohesion: 0.50
Nodes (3): API Contract: Content Delivery (Hydrated), Error Response (404 Not Found), Success Response (200 OK)

### Community 848 - "Community 848"
Cohesion: 0.50
Nodes (3): Contract: Webhook Deployment Payload, Expected Response, Payload

### Community 849 - "Community 849"
Cohesion: 0.50
Nodes (4): duration_ms, easing, stagger_ms, enter
...
Cohesion: 0.50
Nodes (3): Additional Bundled Specs, Catalog, Website Catalog
...
Cohesion: 0.50
Nodes (4): Identify Subprompts, Naming Conventions, Step 3: Propose Structure, Variable Extraction
...
Cohesion: 0.50
Nodes (3): _extract_partial_explanation(), AI Agent application service.  Orchestrates LangChain to generate content schema, Helper to extract the partial explanation string from a streaming JSON block.

## Knowledge Gaps
- **5568 isolated node(s):** `name`, `description`, `hidden`, `systemPromptSections`, `toolNames` (+5563 more)
...
- **Why does `AIService` connect `AI Copilot Drafting Service` to `AI Agent Session Management`, `Module Group 200`, `Community 874`, `AI Self-Correction Loop`, `Community 846`, `MCP Tool Adapters (Python)`, `Module Group 304`, `Module Group 48`, `AI Authoring Service Core`, `Schema Validator Domain Tests`, `Module Group 248`, `Module Group 57`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `showcase` connect `Module Group 172` to `Module Group 160`, `Module Group 195`, `Module Group 103`, `Module Group 104`, `Module Group 334`, `Module Group 80`, `Module Group 377`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `showcase` connect `Module Group 118` to `Module Group 328`, `Module Group 53`, `Module Group 184`, `Module Group 153`, `Module Group 93`, `Module Group 94`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Are the 43 inferred relationships involving `AIService` (e.g. with `AIAgentSession` and `ConversationMessage`) actually correct?**
  _`AIService` has 43 INFERRED edges - model-reasoned connections that need verification._
- **Are the 23 inferred relationships involving `AIAgentSession` (e.g. with `AIAgentSessionModel` and `AIService`) actually correct?**
  _`AIAgentSession` has 23 INFERRED edges - model-reasoned connections that need verification._
- **Are the 21 inferred relationships involving `DraftingService` (e.g. with `AIAgentSession` and `AIService`) actually correct?**
  _`DraftingService` has 21 INFERRED edges - model-reasoned connections that need verification._
- **What connects `Configuration management for the AI Agent Service. Uses pydantic-settings to loa`, `Application settings.`, `FastAPI AI Microservice entry point.  Exposes:   - POST /api/ai/generate-schema` to the rest of the system?**
