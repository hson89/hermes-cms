...
- **DraftingSession**: A Payload CMS collection representing the active state of an AI drafting interaction, linking a Tenant, User, and ContentType, containing up to 10 snapshot versions for draft recovery/rollback (storing rich-text fields as Payload Lexical JSON resolved from AI-generated Markdown).
